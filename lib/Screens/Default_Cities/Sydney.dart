...
class Sydney extends StatefulWidget {
  Sydney({Key? key}) : super(key: key);


  @override
  State<Sydney> createState() => _SydneyState();
}

class _SydneyState extends State<Sydney> {
  ...
  Future getlocation() async {
    ...
    String url = Constants.weatherEndpoint + "Sydney";
          ...
          Container(
            ...
            decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("assets/images/weather_image3.png"),
                  fit: BoxFit.fill,
                )),
          ),
          Scaffold(
